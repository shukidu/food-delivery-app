      ...
      <form>
        ...
        <div class="name">
          ...
          <div class="input-container">
            <input type="text" v-model="formData.name" id="name" placeholder="Please enter receiver's name">
          </div>
        </div>
        <div class="gender">
        ...
        <div class="phone">
          ...
          <div class="input-container">
            <input type="text" v-model="formData.phone" id="phone" placeholder="Please enter phone number">
          </div>
        </div>
        <h3>收货地址</h3>
        <div class="location">
