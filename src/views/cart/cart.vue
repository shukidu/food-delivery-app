<template>
    <div id="cart">
      <v-head title="Cart" goBack="true" bgColor="#f4f4f4">
        <span slot="edit-cart" class="edit" @click="editStatus = true;" v-if="!editStatus">Edit</span>
        <span slot="cancel-edit-cart" class="edit" @click="editStatus = false;" v-else>Cancel</span>
      </v-head>
  
      <div class="empty-cart" v-if="emptyCart">
        <div class="info-container">
          <img src="../../assets/nothing.png">
          <span class="text">cart is empty, go shopping!</span>
          <router-link class="redirect-index" to="/index"><span>here to shop</span></router-link>
        </div>
      </div>
